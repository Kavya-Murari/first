...
sshpass -p "$PASSWORD" scp target/first.war kavya@172.17.0.3:/home/kavya/devops/apache-tomcat-8.5.38/webapps
...
sshpass -p "$PASSWORD" scp target/first.war kavya@172.17.0.4:/home/kavya/devops/apache-tomcat-8.5.38/webapps
...
sshpass -p "$PASSWORD" scp target/first.war kavya@172.17.0.5:/home/kavya/devops/apache-tomcat-8.5.38/webapps
